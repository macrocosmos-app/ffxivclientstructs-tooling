    ...
    class IdaApi(BaseApi):
        ...
        def add_struct_member(self, sid, name):
            idc.add_struc_member(
                sid, name, offset=-1, flag=idc.FF_DATA | idc.FF_QWORD, typeid=-1, nbytes=8, reftype=idc.REF_OFF64
            )
...
class FfxivClassFactory:
    ...
    def register(self, *args):
        ...
        if arg_types != [int, str, list, dict] and arg_types != [long, str, list, dict]:  # py2
...
class FfxivClass:
    ...
    def hierarchy_names(self):
        ...
        if self._hierarchy_names is None:
            self._hierarchy_names = list(itertools.chain(*[cls.hierarchy_names for cls in self.hierarchy])) + [
                self.name
            ]
    ...
    def vtbl_size(self):
        ...
        if self._vtbl_size == 0:
            ...
            if self.vtbl_size < parent_vtbl_size:
                print(
                    'Error: The sum of "{0}"\'s parent vtbl sizes ({1}) is greater than the actual class itself ({2})'.format(
                        self.name, parent_vtbl_size, self._vtbl_size
                    )
                )
        ...
        for idx in range(0, self.vtbl_size):
            ...
            if idx in self.funcs:
                ...
                if current_func_name.startswith(self.SUB_PREFIX):
                    ...
                    full_func_name = parent_full_func_name or self.GENERIC_NULLSUB_FORMAT.format(
                        cls=self.name, index=idx
                    )
                    ...
                    print(
                        "Warning: qword in vtbl at 0x{0:X}, it may be an offset to undefined code".format(vfunc_offset)
                    )
                    full_func_name = None
                    ...
                    print(
                        'Error: Unexpected function name "{0}" at 0x{1:X}'.format(
                            current_func_name, self.vtbl_ea + idx * 8
                        )
                    )
                    full_func_name = None
        ...
        for ea, func_name in self.funcs.items():
            if ea > 0x1000:
                ...
                # check that the name is unnamed
                    ...
                    for prefix in [self.SUB_PREFIX, self.NULLSUB_PREFIX, self.LOC_PREFIX]
                ):
...
api.set_addr_name(
    0x1401B0460, "ResourceManager_GetResourceAsync"
)  # no vtbl on this class wouldn't be surprised if it was Client::System::Resource::ResourceManager or something though
...
api.set_addr_name(
    0x141DB1D00, "g_BattleCharaStore"
)  # this is a struct/object containing a list of all battlecharas (0x100) and the memory ptrs below
...
factory.register(
    0x14164F448, "Client::System::Framework::TaskManager::RootTask", ["Client::System::Framework::Task"], {}
)
factory.register(
    0x14164F460,
...
factory.register(
    0x14164F478, "Client::System::Configuration::SystemConfig", ["Common::Configuration::SystemConfig"], {}
)
...
factory.register(
    ...
    ["Component::GUI::AtkModule", "Common::Configuration::ConfigBase::ChangeEventInterface"],
    {
        39: "SetUIVisibility",
        0x1400B06F0: "ctor",
...
factory.register(
    ...
    ["Client::Graphics::Kernel::Resource", "Client::Graphics::DelayedReleaseClassBase"],
    {
        0x1402F9930: "ctor",
    },
)
...
factory.register(
    ...
    ["Client::Graphics::Render::Camera", "Client::Graphics::ReferencedClassBase"],
    {},
)
...
factory.register(
    ...
    ["Client::Graphics::RenderObjectList", "Client::System::Framework::Task"],
    {},
)
factory.register(
    0x1416859C0,
...
factory.register(
    0x141685AB8, "Client::Graphics::Render::GeometryInstancingRenderer", ["Client::Graphics::Render::BaseRenderer"], {}
)
factory.register(
    0x141685B60,
    "Client::Graphics::Render::BGInstancingRenderer_Client::Graphics::JobSystem_CClient::Graphics::Render::tagInstancingContainerRenderInfo",
    [],
    {},
)
factory.register(
...
factory.register(
    0x141685BD8, "Client::Graphics::Render::TerrainRenderer", ["Client::Graphics::Render::BaseRenderer"], {}
)
factory.register(
    0x141685C48, "Client::Graphics::Render::UnknownRenderer", ["Client::Graphics::Render::BaseRenderer"], {}
)
factory.register(
    0x141685CB0,
...
factory.register(
    0x141685DA8, "Client::Graphics::Render::VerticalFogRenderer", ["Client::Graphics::Render::BaseRenderer"], {}
)
...
factory.register(
    0x141685EF0, "Client::Graphics::Render::Updater_Client::Graphics::Render::PostBoneDeformerBase", [], {}
)
...
factory.register(
    ...
    ["Client::Graphics::Singleton", "Client::Graphics::Kernel::Notifier"],
    {},
)
factory.register(
    0x141685F60,
...
factory.register(
    ...
    ["Client::Graphics::Scene::Object", "Client::Graphics::Singleton"],
    {
        0x14042C290: "ctor",
    },
)
factory.register(
    0x141695BD0, "Client::Graphics::Scene::World_Client::Graphics::Singleton", ["Client::Graphics::Singleton"], {}
)
factory.register(
    0x141695BD8,
...
factory.register(
    ...
    ["Component::GUI::AtkComponentButton", "Component::GUI::AtkDragDropInterface"],
    {
        0x1404F6E20: "ctor",
    },
)
...
factory.register(
    ...
    ["Component::GUI::AtkComponentInputBase", "Component::GUI::AtkTextInput::AtkTextInputEventInterface"],
    {
        0x140519950: "ctor",
    },
)
...
factory.register(
    0x14169C3C0, "Component::GUI::AtkNineGridNodeRenderer", ["Component::GUI::AtkResourceRendererBase"], {}
)
factory.register(0x14169C3D8, "Component::GUI::AtkCounterNodeRenderer", ["Component::GUI::AtkResourceRendererBase"], {})
factory.register(
    0x14169C3F0, "Component::GUI::AtkComponentNodeRenderer", ["Component::GUI::AtkResourceRendererBase"], {}
)
factory.register(
    0x14169C408,
...
factory.register(
    ...
    ["Component::GUI::AtkComponentBase", "Component::GUI::AtkDragDropInterface"],
    {
        0x14052B840: "ctor",
    },
)
...
factory.register(
    ...
    ["Component::GUI::AtkComponentWindowGrab", "Component::GUI::AtkComponentBase"],
    {
        0x14052DDD0: "ctor",
    },
)
...
factory.register(
    ...
    ["Component::Text::MacroDecoder", "Client::System::Common::NonCopyable"],
    {},
)
factory.register(
    0x1416AEAE8,
...
factory.register(
    ...
    ["Client::Game::Object::GameObject", "Client::Graphics::Vfx::VfxDataListenner"],
    {
        3: "GetObjectKind",
        16: "EnableDraw",
        17: "DisableDraw",
...
factory.register(
    ...
    ["Client::UI::Agent::AgentInterface", "Common::Configuration::ConfigBase::ChangeEventInterface"],
    {
        5: "Update",
        0x14081F350: "ctor",
...
factory.register(
    ...
    ["Client::UI::Agent::AgentItemDetailBase", "Client::UI::Agent::AgentInterface"],
    {
        0x1408D3F50: "ctor",
...
factory.register(
    0x1416E05C8, "Client::Game::Event::EventSceneModuleUsualImpl", ["Client::Game::Event::EventSceneModuleImplBase"], {}
)
...
factory.register(
    ...
    ["Client::Game::Gimmick::GimmickEventHandler", "Client::Game::InstanceContent::ContentSheetWaiterInterface"],
    {},
)
factory.register(
    0x141798F70,
...
factory.register(
    ...
    ["Client::UI::AddonItemDetailBase", "Component::GUI::AtkUnitBase", "Component::GUI::AtkManagedInterface"],
    {
        0x140E90440: "ctor",
...
factory.register(
    0x1418334C8,
    "Component::Log::LogModule",
    ["Component::Log::LogModuleInterface", "Client::System::Common::NonCopyable"],
    {},
)
factory.register(
    0x1418791E0, "Client::Game::Gimmick::GimmickEventHandler", ["Client::Game::Event::LuaEventHandler"], {}
)
factory.register(
    0x14187A2A0,
